...
impl TryFrom<Connector> for RoutableConnectors {
    ...
    fn try_from(connector: Connector) -> Result<Self, Self::Error> {
        match connector {
            ...
            Connector::AirtelTigoCash => Ok(Self::AirtelTigoCash),
            ...
            Connector::MtnMobileMoney => Ok(Self::MtnMobileMoney),
            ...
            Connector::TelecelCash => Ok(Self::TelecelCash),
            ...
            Connector::Ghipss => Ok(Self::Ghipss),
...
impl From<RoutableConnectors> for Connector {
    fn from(routable_connector: RoutableConnectors) -> Self {
        match routable_connector {
            ...
            RoutableConnectors::AirtelTigoCash => Self::AirtelTigoCash,
            ...
            RoutableConnectors::Ghipss => Self::Ghipss,
            ...
            RoutableConnectors::GotymeSanlam => Self::GotymeSanlam,
            ...
            RoutableConnectors::MtnMobileMoney => Self::MtnMobileMoney,
            ...
            RoutableConnectors::TelecelCash => Self::TelecelCash,

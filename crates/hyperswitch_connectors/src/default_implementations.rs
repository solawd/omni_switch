...
macro_rules! default_imp_for_payment_settlement_split_create {
    ($($path:ident::$connector:ident),*) => {
...
/// Every connector in the `default_imp_for_revenue_recovery!` list needs a
...
macro_rules! default_imp_for_connector_webhook_register {
    ($($path:ident::$connector:ident),*) => {
        $(
...
#[cfg(feature = "dummy_connector")]
impl<const T: u8> PaymentsGenerateQr for connectors::DummyConnector<T> {}
#[cfg(feature = "dummy_connector")]
impl<const T: u8> ConnectorIntegration<GenerateQr, GenerateQrRequestData, PaymentsResponseData>
    for connectors::DummyConnector<T>
{
}
...
#[cfg(all(feature = "v2", feature = "revenue_recovery"))]
#[cfg(feature = "dummy_connector")]
impl<const T: u8> RevenueRecoveryDisputeRecordBack for connectors::DummyConnector<T> {}
#[cfg(all(feature = "v2", feature = "revenue_recovery"))]
#[cfg(feature = "dummy_connector")]
impl<const T: u8>
...
macro_rules! default_imp_for_generate_qr_flow{
    ($($path:ident::$connector:ident),*)=> {
        $(
            impl PaymentsGenerateQr for $path::$connector {}
            impl
            ConnectorIntegration<
            GenerateQr,

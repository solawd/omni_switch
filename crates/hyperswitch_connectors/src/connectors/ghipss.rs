...
impl api::Payment for Ghipss {}
impl api::PaymentSession for Ghipss {}
impl api::ConnectorAccessToken for Ghipss {}
impl api::MandateSetup for Ghipss {}
impl api::PaymentAuthorize for Ghipss {}
impl api::PaymentSync for Ghipss {}
impl api::PaymentCapture for Ghipss {}
impl api::PaymentVoid for Ghipss {}
impl api::Refund for Ghipss {}
impl api::RefundExecute for Ghipss {}
impl api::RefundSync for Ghipss {}
impl api::PaymentToken for Ghipss {}
...
impl<Flow, Request, Response> ConnectorCommonExt<Flow, Request, Response> for Ghipss
where
...
impl ConnectorCommon for Ghipss {
    ...
    fn base_url<'a>(&self, connectors: &'a Connectors) -> &'a str {
        connectors.ghipss.base_url.as_ref()
    }
    ...
    fn get_auth_header(&self, auth_type:&ConnectorAuthType)-> CustomResult<Vec<(String,hyperswitch_masking::Maskable<String>)>,errors::ConnectorError> {
        let auth =  ghipss::GhipssAuthType::try_from(auth_type)
    ...
    fn build_error_response(
        ...
        let response: ghipss::GhipssErrorResponse = res
            .response
            .parse_struct("GhipssErrorResponse")
...
impl ConnectorValidation for Ghipss
{
...
impl
    ...
    fn get_request_body(&self, req: &PaymentsAuthorizeRouterData, _connectors: &Connectors,) -> CustomResult<RequestContent, errors::ConnectorError> {
        ...
        let connector_router_data =
            ghipss::GhipssRouterData::from((
                amount,
                req,
            ));
        let connector_req = ghipss::GhipssPaymentsRequest::try_from(&connector_router_data)?;
    ...
    fn handle_response(
        ...
        let response: ghipss::GhipssPaymentsResponse = res.response.parse_struct("Ghipss PaymentsAuthorizeResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
    ...
    for Ghipss
{
    ...
    fn handle_response(
        ...
        let response: ghipss:: GhipssPaymentsResponse = res
            .response
            .parse_struct("ghipss PaymentsSyncResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
    ...
    > for Ghipss
{
    ...
    fn handle_response(
        ...
        let response: ghipss::GhipssPaymentsResponse = res
            .response
            .parse_struct("Ghipss PaymentsCaptureResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl
    ...
    fn get_request_body(&self, req: &RefundsRouterData<Execute>, _connectors: &Connectors,) -> CustomResult<RequestContent, errors::ConnectorError> {
        ...
        let connector_req = ghipss::GhipssRefundRequest::try_from(&connector_router_data)?;
        Ok(RequestContent::Json(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: ghipss::RefundResponse = res.response.parse_struct("ghipss RefundResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
            response,
...
impl
    ConnectorIntegration<RSync, RefundsData, RefundsResponseData> for Ghipss {
    ...
    fn handle_response(
        ...
        let response: ghipss::RefundResponse = res.response.parse_struct("ghipss RefundSyncResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
            response,
...
impl webhooks::IncomingWebhook for Ghipss {
...
static GHIPSS_SUPPORTED_PAYMENT_METHODS: LazyLock<SupportedPaymentMethods> =
    LazyLock::new(SupportedPaymentMethods::new);

static GHIPSS_CONNECTOR_INFO: ConnectorInfo = ConnectorInfo {
    display_name: "GHIPSS",
    description: "GHIPSS connector",
    connector_type: enums::HyperswitchConnectorCategory::PaymentGateway,
    integration_status: enums::ConnectorIntegrationStatus::Live,
};

static GHIPSS_SUPPORTED_WEBHOOK_FLOWS: [enums::EventClass; 0] = [];

impl ConnectorSpecifications for Ghipss {
    fn get_connector_about(&self) -> Option<&'static ConnectorInfo> {
        Some(&GHIPSS_CONNECTOR_INFO)
    }

    fn get_supported_payment_methods(&self) -> Option<&'static SupportedPaymentMethods> {
        Some(&*GHIPSS_SUPPORTED_PAYMENT_METHODS)
    }

    fn get_supported_webhook_flows(&self) -> Option<&'static [enums::EventClass]> {
        Some(&GHIPSS_SUPPORTED_WEBHOOK_FLOWS)
    }
}

...
#[derive(Clone, Copy)]
struct GhipssTest;
impl ConnectorActions for GhipssTest {}
impl utils::Connector for GhipssTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Ghipss;
        utils::construct_connector_data_old(
            Box::new(Ghipss::new()),
            types::Connector::Ghipss,
...
static CONNECTOR: GhipssTest = GhipssTest {};
...
async fn should_fail_payment_for_incorrect_cvc() {
    ...
    assert_eq!(
        ...
        // TODO(ghipss): replace with your connector's actual error message
